<table>
    @foreach($ingredients as $ingredient)
        <tr>
            ...
            <td><input value="{{ $ingredient->value ?? null }}" {{ $ingredient->value ? null : 'disabled' }} data-id="{{ $ingredient->id }}" name="ingredients[{{ $ingredient->id }}]" type="text" class="ingredient-amount form-control" placeholder="{{ trans('global.amount') }}"></td>
        </tr>
    @endforeach
</table>
